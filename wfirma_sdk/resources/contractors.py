...
class ContractorsResource:
    ...
    def add(self, contractor_fields: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self._client._post_module_record("/contractors/add", module_plural="contractors", record_name="contractor", fields=contractor_fields)
    ...
    def edit(self, contractor_id: int | str, fields: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return self._client._post_module_record(f"/contractors/edit/{contractor_id}", module_plural="contractors", record_name="contractor", fields=fields)

    def find(self, parameters_xml: bytes | str | None = None, *, page: int | None = None, limit: int | None = None, fields: list[str] | None = None) -> Dict[str, Any]:
        """POST /contractors/find with <parameters> in body. Provide full XML or basic paging via kwargs."""
        if parameters_xml is not None:
            return self._client._request("POST", "/contractors/find", data=parameters_xml)
        # basic builder
        xml = self._client._build_parameters_xml("contractors", page=page, limit=limit, fields=fields)
